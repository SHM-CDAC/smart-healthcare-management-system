import { fetchDoctorCancelledApmts } from "../../services/doctorService";
import { useState,useEffect } from "react";
import { useSelector } from "react-redux";
import { toast } from "react-toastify";

const DoctorCancelledApmts = ()=>{
    ...
    useEffect(()=>{
            ...
            const fetchApmtHistory = async()=>{
                try{
                    const response = await fetchDoctorCancelledApmts(doctor.doctorId);
    ...
    return(
         <div className="container">
            <div className="container-fluid">
                {apmtHistory.length === 0 ? <h5 className="mb-5 mt-lg-0 mt-5 text-center text-success">You don’t have any cancelled appointment.</h5> : 
                <div>
                        ...
                        <div className="col-12 d-flex flex-wrap gap-5 justify-content-center">
                            {apmtHistory.map((apmt)=>(
                                ...
                                <div className="p-2 shadow-lg mb-1">
                                    ...
                                    <p className="mb-1"><b>Status:</b> {apmt.status === "CANCELLED_BY_PATIENT" ? "CANCELLED BY PATIENT":"CANCELLED BY YOU"}</p>
                                </div>
                                </div>
                                </div>
                            ))}
...
export default DoctorCancelledApmts;